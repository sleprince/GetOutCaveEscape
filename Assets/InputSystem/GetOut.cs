...
//     version 1.4.4
//     from Assets/InputSystem/GetOut.inputactions
//
...
public partial class @GetOut : IInputActionCollection2, IDisposable
{
    ...
    {
        private @GetOut m_Wrapper;
        public PlayerActions(@GetOut wrapper) { m_Wrapper = wrapper; }
